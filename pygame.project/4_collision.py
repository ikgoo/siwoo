...
while running == True:
    ...
    ball_ract = ball_images[ball_img_idx].get_rect()
    ball_ract.left = ball_pos_x
    ball_ract.top = ball_pos_y


    if chacracter_rect.colliderect(ball_ract):
        running = False
        break
    ...
    for weapon_idx, weapon_val in enumerate(weapons):
        ...
        if weapon_rect.colliderect(ball_ract):
